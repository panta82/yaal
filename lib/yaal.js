var libTools = require("./tools"),
	...
	makeCollector = require("./collectors/makeCollector");
...
function yaal(fns) {
	...
	var fnsIsObject = libTools.isObject(fns),
		collector = makeCollector(options.hash || fnsIsObject ? "hash" : "array", options);
