exports.DEFAULT_OPTIONS = {
	...
	/*
	 ...
	 Numbering starts at 1. Note that this is general hash operation, unrelated with the 'hash' switch
	 */
	...
	/*
		Produce hash result for list-of-tasks or single-task modes. In the first case, hash keys
	...
	/*
		Index of the argument to use as key in the single-task scenario. By default, extract the element 0.
